...
<div class="card">
    ...
    <div class="card-body">
            ...
            <div class="row">
				<div class="col-sm-4 right">Name</div>
				<div class="col-sm-8">: {{ $users->name }}</div>
			</div>
            <div class="row">
				<div class="col-sm-4 right">Email</div>
				<div class="col-sm-8">: {{ $users->email }}</div>
			</div>
            <div class="row">
				<div class="col-sm-4 right">Email Verified At</div>
				<div class="col-sm-8">: {{ $users->email_verified_at }}</div>
			</div>
            <div class="row">
            ...
            <div class="row">
				<div class="col-sm-4 right">Phone</div>
				<div class="col-sm-8">: {{ $users->phone }}</div>
			</div>
            <div class="row">
				<div class="col-sm-4 right">Lineid</div>
				<div class="col-sm-8">: {{ $users->lineid }}</div>
			</div>
            <div class="row">
